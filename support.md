...
> **Need a person?** Email us at **[feedback.glimpse@gmail.com](mailto:feedback.glimpse@gmail.com)** and we'll get back to you, usually within 2 business days.

---

## What is Glimpse?

Glimpse is a proximity-based dating and social app. Instead of swiping through people who could be anywhere in the world, Glimpse only shows you people who are actually nearby — at the same café, event, gym, or street. When two phones running Glimpse come close to each other, they notice one another over Bluetooth and the people appear on each other's screen.

From there you can:

- **Summon someone** — a lightweight nudge that says "I noticed you."
- **Like** someone you're interested in.
- **Meet** — confirm you'd like to actually say hello in person.
- **Decide** — after an encounter, choose whether you want to stay connected.

When interest is mutual, both people get a notification so you know it's worth saying hi.
...
## Permissions Glimpse asks for, and why
...
### Does Glimpse track my location?

No. Glimpse does not use GPS or share your map location. It works by noticing when another Glimpse phone is within Bluetooth range — it knows someone is *near*, not *where* either of you are on a map.

### How do I stop being seen by people around me?

Turn visibility off inside the app. While you're hidden, nearby users will not see you and you won't appear in anyone's list. You can turn it back on whenever you like.
...
A summon is a low-pressure way to let a nearby person know you noticed them, without fully committing to a like. If they summon you back, you'll both be notified.
...
> **Du brauchst einen echten Menschen?** Schreib uns an **[feedback.glimpse@gmail.com](mailto:feedback.glimpse@gmail.com)**, wir melden uns in der Regel innerhalb von 2 Werktagen zurück.

---

## Was ist Glimpse?

Glimpse ist eine auf Nähe basierende Dating- und Social-App. Anstatt dich durch Menschen zu wischen, die irgendwo auf der Welt sein könnten, zeigt dir Glimpse nur Menschen, die tatsächlich in deiner Nähe sind – im selben Café, beim selben Event, im Fitnessstudio oder auf der Straße. Wenn zwei Telefone mit Glimpse einander nahekommen, bemerken sie sich über Bluetooth und die Personen erscheinen gegenseitig auf dem Bildschirm.

Von dort aus kannst du:

- **Jemanden summonen** – ein leichter Anstoß, der sagt „Ich habe dich bemerkt.“
- **Jemanden liken**, der dich interessiert.
- **Meet** – bestätigen, dass du wirklich persönlich Hallo sagen möchtest.
- **Decide** – nach einer Begegnung entscheiden, ob du in Kontakt bleiben möchtest.

Wenn das Interesse gegenseitig ist, bekommen beide eine Benachrichtigung, damit du weißt, dass es sich lohnt, Hallo zu sagen.
...
## Welche Berechtigungen Glimpse anfragt – und warum
...
### Warum sehe ich niemanden in der Nähe?
...
### Verfolgt Glimpse meinen Standort?

Nein. Glimpse nutzt kein GPS und teilt deinen Kartenstandort nicht. Es funktioniert, indem es bemerkt, wenn sich ein anderes Glimpse-Telefon in Bluetooth-Reichweite befindet – es weiß, dass jemand *in der Nähe* ist, nicht *wo* ihr euch auf einer Karte befindet.

### Wie verhindere ich, dass mich Menschen in der Umgebung sehen?

Schalte die Sichtbarkeit in der App aus. Solange du verborgen bist, sehen dich Nutzer in der Nähe nicht und du erscheinst in niemandes Liste. Du kannst sie jederzeit wieder einschalten.
...
Ein Summon ist eine entspannte Möglichkeit, einer Person in der Nähe mitzuteilen, dass du sie bemerkt hast, ohne dich gleich auf ein Like festzulegen. Wenn sie dich zurück-summoned, werdet ihr beide benachrichtigt.
